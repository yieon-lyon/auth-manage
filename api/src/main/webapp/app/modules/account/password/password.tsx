...
export const PasswordPage = (props: IUserPasswordProps) => {
  ...
  const handleValidSubmit = (event, values) => {
    props.savePassword(props.account.email, values.currentPassword, values.newPassword);
  };
      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="password-title">
            <Translate contentKey="password.title" interpolate={{ username: props.account.email }}>
              Password for {props.account.email}
            </Translate>
          </h2>
