...
import com.yieon.practice.auth.security.jwt.JWTConfigurer;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfiguration(WebAuthenticationProvider webAuthenticationProvider, CorsFilter corsFilter, SecurityProblemSupport problemSupport) {
    ...
    private JWTConfigurer securityConfigurerAdapter() {
        return new JWTConfigurer(webAuthenticationProvider);
    }
}
