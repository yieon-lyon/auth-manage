...
public class JWTFilter extends GenericFilterBean {
    ...
    public JWTFilter(WebAuthenticationProvider webAuthenticationProvider) {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        if (StringUtils.hasText(jwt) && this.webAuthenticationProvider.validateToken(jwt)) {
            Authentication authentication = this.webAuthenticationProvider.getAuthentication(jwt);
